      ...
      >
        <View style={styles.formContainer}>
          ...
          <Text style={styles.title}>
            {isLogin ? 'Authentication System' : 'Create Account'}
          </Text>
          <Text style={styles.subtitle}>
            {isLogin ? 'Welcome Back! Please sign in to continue' : 'Please fill in the form to continue'}
          </Text>
